...
export const FEATURE_CATALOG = [
  ...
  { category: 'Reports', items: [
    { key: 'packout', label: 'Packout Report', desc: 'Raw lbs in vs packed lbs out, fruit flow reconciliation' },
...
export const FEATURE_PRESETS = [
  ...
  },
  {
    ...
    features: {
      detailedMode: true, packCriteria: true, lineStats: false, extraSamples: true,
      ...
      speedQuality: false, growerTrends: false, opsPanel: false, lineMonitor: false,
      packout: false, dcReconcile: false, dailyView: false, shareButton: false,
  ...
  },
  {
    ...
    features: {
      detailedMode: true, packCriteria: true, lineStats: true, extraSamples: true,
      skipControls: true, imageCapture: false, training: false,
      packPlan: true, packLog: true, palletType: true, specialInstructions: true,
      speedQuality: true, growerTrends: true, opsPanel: true, lineMonitor: true,
      packout: true, dcReconcile: true, dailyView: true, shareButton: true,
  ...
  },
  {
    ...
    features: {
      detailedMode: false, packCriteria: true, lineStats: true, extraSamples: true,
      skipControls: true, imageCapture: true, training: false,
      packPlan: true, packLog: true, palletType: true, specialInstructions: true,
      speedQuality: false, growerTrends: false, opsPanel: false, lineMonitor: true,
      packout: false, dcReconcile: false, dailyView: true, shareButton: false,
      prePack: true, prePackBanner: true,
